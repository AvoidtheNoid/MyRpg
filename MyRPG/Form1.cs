...
namespace MyRPG
{
    public partial class Game : Form
    {
        ...
        public Game()
        {
            ...
            _player.Inventory.Add(new Inventory(World.ItemByID(World.ITEM_ID_RUSTY_SWORD), 1));
        ...
        private void MoveTo(Location newLocation)
        {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            _player.ExperiencePts += newLocation.QuestAvailableHere.RewardExperiencePoints;
            ...
            if (newLocation.EnemyLivingHere != null)
            {
                ...
                Enemy standardMonster = World.EnemyByID(newLocation.EnemyLivingHere.ID);

                _currentMonster = new Enemy(standardMonster.ID, standardMonster.Name, standardMonster.MaximumDamage,
                    standardMonster.RewardExperiencePoints, standardMonster.RewardGold, standardMonster.CurHitPoints, standardMonster.MaxHitPoints);
        ...
        private void UpdateInventoryListInUI()
        {
            ...
            foreach (Inventory inventoryItem in _player.Inventory)
            {
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            _currentMonster.CurHitPoints -= damageToMonster;

            // Display message
            rtbMessages.Text += "You hit the " + _currentMonster.Name + " for " + damageToMonster.ToString() + " points." + Environment.NewLine;

            // Check if the monster is dead
            if (_currentMonster.CurHitPoints <= 0)
            {
                // Monster is dead
                rtbMessages.Text += Environment.NewLine;
                ...
                _player.ExperiencePts += _currentMonster.RewardExperiencePoints;
            ...
            else
            {
                ...
                _player.CurHitPoints -= damageToPlayer;

                // Refresh player data in UI
                lblHP.Text = _player.CurHitPoints.ToString();

                if (_player.CurHitPoints <= 0)
                {
                    // Display message
        ...
        private void btnUsePotion_Click(object sender, EventArgs e)
        {
            ...
            _player.CurHitPoints = (_player.CurHitPoints + potion.AmountToHeal);

            // CurrentHitPoints cannot exceed player's MaximumHitPoints
            if (_player.CurHitPoints > _player.MaxHitPoints)
            {
                _player.CurHitPoints = _player.MaxHitPoints;
            }
